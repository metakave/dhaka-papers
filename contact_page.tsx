                    ...
                    <div className="space-y-10">
                        <div className="bg-gray-50 p-8 border-l-8 border-primary shadow-sm">
                            ...
                            <address className="not-italic text-lg text-gray-700 leading-relaxed font-bold">
                                ঢাকা পেপারস<br />
                                বাসা ৭৭, সড়ক ৯, ব্লক সি (দ্বিতীয় তলা)<br />
                                নিকেতন, গুলশান, ঢাকা- ১২১২।<br />
                                ফোন: +৮৮ ০২ ৪৮৮ ১৫০ ২১
                            </address>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-xl font-bold text-gray-900 border-b-2 border-gray-100 pb-1">01736-123902</p>
                            </div>
                        </div>
                    </div>
