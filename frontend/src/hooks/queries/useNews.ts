...
export const useInfiniteNews = (params?: { limit?: number; category?: string; authorId?: string; sort?: string; featured?: boolean; isBrief?: boolean; search?: string; tag?: string; lang?: string }) => {
    return useInfiniteQuery({
        queryKey: ['news', 'infinite', params],
        queryFn: ({ pageParam = 1 }) => newsService.getAll({
            ...params,
            author_id: params?.authorId,
            is_brief: params?.isBrief,
