...
func (h *SeedHandler) SEED_CreateNews(w http.ResponseWriter, r *http.Request) {
	...
	news, err := h.svc.CreateNews(r.Context(), authorID, categoryID, req.Title, titleEn, req.Excerpt, req.Content, req.ThumbnailURL, "", []string{}, req.IsFeatured, "published", time.Now())
	if err != nil {
